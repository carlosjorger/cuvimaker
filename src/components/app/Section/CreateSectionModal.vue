<template>
	<ModalTemplate>
		<div
			class="m-0 flex w-1/2 flex-col rounded-lg border-primary bg-base-100 p-3 max-xl:w-1/2 max-lg:w-4/5 max-md:w-11/12 max-sm:w-11/12 max-sm:p-2"
		>
			...
			<div class="box-border px-5 text-left" v-else>
